...
<html>
<head>
<title>Music Request System LITE - Free The Line</title>
...
<?php
	...
	if($admin !== true)
	{
		echo("<script type=\"text/javascript\">window.location = 'login.php?ref=open_system'</script>");
		echo("You are not signed in. You should be automatically redirected. If you are not, please <a href=\"login.php?ref=open_system\">click here</a>.");
		$disabled=true;
	}
	if(!empty($_POST['s']))
	{
		...
		$disabled=true;
		echo("The system is now OPEN. Please <a href=\"index.php\">click here</a> to leave this page.");
	}
?>
<h1>Music Request System LITE</h1>
<h2>Open System</h2>
<form method="post" action="open_system.php">
<input type="hidden" name="s" value="y">
<input type="submit" value="Confirm open" <?php if($disabled === true) { echo "disabled=\"disabled\""; } ?>>
</form>
