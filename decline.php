...
<html>
<head>
<title>Music Request System LITE - Decline Request</title>
...
<?php
	...
	if($admin !== true || $editable !== true)
	{
		...
		die("You are not authorized to decline this post. You should be automatically redirected. If you are not, please <a href=\"index.php\">click here</a>.");
	}
	...
	if(!empty($_GET['s']) && $disabled === false)
	{
		...
		$request["Status"]=2;
		$request["LastAction"]=array("DECLINED",time());
		...
		echo("<p>Request has been declined. Please <a href=\"index.php\">click here</a>.</p>");
		$disabled=true;
	}
?>
...
<input type="submit" value="Confirm denial" <?php if($disabled === true) { echo "disabled=\"disabled\""; } ?>>
</form>
